    ...
    try:
        for item in os.listdir(folder_path):
            ...
            if os.path.isfile(item_path):
                ...
                os.rmdir(item_path)  
        print("Folder 'FordCompression' Cleared")    
...
def main():
    ...
    output_path_compressed_images = r"C:\Users\ryanj\Documents\2024ResearchV2\FordCompressed"  # Put a temp folder path here
    output_folder = r"C:\Users\ryanj\Documents\2024ResearchV2\SAVE_HERE"                      #final ouput folder path here
